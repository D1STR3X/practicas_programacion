...
public class Ejercicio35 {
	...
	//Dado un número n, dibujar una figura como ésta, consistente en una fila de n asteriscos (tal que 1<= n <= 20)
	public static void main (String[] args) {
		...
		else System.out.println(n + " no cumple con los requisitos especificados");
	}
}