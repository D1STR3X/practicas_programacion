...
public class Ejercicio14 {
	...
	//Dadas dos matrices de 3x3 “a” y “b” mostrar su contenido y el contenido de la matriz resultante de multiplicar ambas matrices.
	public static void main(String[] args) {
		...
		for (int cont1 = 0; cont1 < a.length; cont1++) {
			for (int cont2 = 0; cont2 < b.length; cont2++) {
				c[cont1][cont2] = a[cont1][0] * b[0][cont2] + a[cont1][1] * b[1][cont2] + a[cont1][2] * b[2][cont2]; 
			}
		}
